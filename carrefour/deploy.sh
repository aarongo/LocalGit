...
mount (){
    ...
    ln -s /software/newupload $Tomcat_Deploy/cybershop-front-0.0.1-SNAPSHOT/assets/upload
	ln -s /software/newupload $Tomcat_Deploy/ROOT/assets/upload
	ln -s /data/www $Tomcat_Deploy/cybershop-front-0.0.1-SNAPSHOT/www
	ln -s /data/www $Tomcat_Deploy/ROOT/
	if [ $? -eq 0 ]; then
		#statements
...
umount (){
	...
	rm -f $Tomcat_Deploy/cybershop-front-0.0.1-SNAPSHOT/www
	if [ $? -eq 0 ]; then
		#statements
